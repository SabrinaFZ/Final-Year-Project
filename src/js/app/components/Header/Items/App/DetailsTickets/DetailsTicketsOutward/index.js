    ...
    return(
      <View style={[common.marginTop20, common.box, common.paddingTopBottom20, common.backgroundColorWhite]}>
        <View style={[common.alignItems]}>
          ...
          <Text style={[common.marginTop20, common.textPink, common.textCenter]}> {((this.props.journeyPlan.links[this.props.selectedOutward.selectedFare].totalPrice)/1000).toFixed(2)} £ </Text>
        </View>
